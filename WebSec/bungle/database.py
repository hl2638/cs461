...
def connect():
    ...
    return mdb.connect(host="localhost",
                       user="hongyil7",
                       passwd="387391ff5e0809b93a4c1be8fdeb39511475dc24edc71e0d2263a8f93f8164ad",
                       db="project2");
...
def createUser(username, password):
    ...
    sql = "INSERT INTO `users` (`username`, `passwordhash`, `salt`) VALUES (%s, %s, %s)"
    cur.execute(sql, (username, passwordhash, salt))
    db_rw.commit()
